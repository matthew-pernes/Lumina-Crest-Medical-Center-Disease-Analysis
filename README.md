...
* **Standardized Name Formatting:** Used the `PROPER` function and removed leading/trailing spaces to ensure patient names were consistent across the 54,000+ records.
